...
import { useDelteSavePost, useGetCurrentUser, useLikePost, useSavePost } from "@/lib/react-query/queriesAndMutations";
...
const PostStats = ({ post, userId }: PostStatsProps) => {
    ...
    const { mutate: deletePost, isPending: isDeletingSaved } = useDelteSavePost();
        ...
        <div className="flex justify-between items-center z-20">
            ...
            <div className="flex gap-2">
                {isSavingPost || isDeletingSaved ? <Loader /> :
                    <img src={isSaved ? "/assets/icons/saved.svg" : "/assets/icons/save.svg"} alt="like"
                        width={20} height={20}
